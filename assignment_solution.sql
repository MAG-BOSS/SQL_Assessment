...
--Find average male employee salary
SELECT AVG(salary)
FROM employee
WHERE sex='M';

--Find sum  of all employee slaries
SELECT SUM(salary)
FROM employee;
...
--Find a list of employee and branch names in the same column
...
--Find all clients who are handled by the branch that Michael Scott manages (Assume you knows Michael ID)
